...
<body>
    <h1>this is a create view of Officer</h1>
    <form method="post" action="{{route('officer.store')}}">
        ...
        <div>
            ...
            <input type="time" name="work_start_time" placeholder="start time">
        </div>
        <div>
            <label>Work_end_time</label>
            <input type="time" name="work_end_time" placeholder="start time">
        </div>
        <div>
