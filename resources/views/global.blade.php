...
<ul class="nav nav-pills nav-fill gap-2 p-1 small bg-primary rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
    <li class="nav-item" role="presentation">
            <a class="nav-link active rounded-5" id="post-tab" href="{{ route('post.index') }}">POST</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link active rounded-5" id="post-tab" href="{{ route('visitor.index') }}">VISITOR</a>
        </li>
        <li class="nav-item bg-primary" role="presentation">
            <a class="nav-link active rounded-5" id="post-tab" href="{{ route('officer.index') }}">OFFICER</a>
        </li>
        <li class="nav-item" role="presentation">
